...
pub struct ClaimTokens<'info> {
    ...
    #[account(
        ...
        has_one = beneficiary, // check to make sure it is the correct beneficiary
        has_one = vesting_account // check for the correct vesting account
    )]
    pub employee_account: Account<'info, EmployeeAccount>,
...
#[account]
#[derive(InitSpace)] // to automatically calculate space
pub struct VestingAccount {
    pub owner: Pubkey, 
    pub mint: Pubkey,
    pub treasury_token_account: Pubkey,// to store the token
...
pub struct EmployeeAccount {
    ...
    pub start_time: i64,
    pub end_time: i64,
    pub cliff_time: i64, // wait time before token unlocks
